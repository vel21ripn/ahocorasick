...
struct aho_node a_node_w1[]= {
    ...
    struct aho_patterns pattern_list_w1[]= {
      ...
      { .len=16, .from_start=0, .at_end=0, .last=1, .code=26, .pattern=1 }, /* 1 */
      { .len=16, .from_start=0, .at_end=0, .last=1, .code=25, .pattern=2 }, /* 2 */
      { .len=14, .from_start=0, .at_end=0, .last=1, .code=24, .pattern=3 }, /* 3 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=5, .pattern=4 }, /* 4 */
      { .len=11, .from_start=0, .at_end=0, .last=1, .code=22, .pattern=5 }, /* 5 */
      { .len=20, .from_start=0, .at_end=0, .last=1, .code=11, .pattern=6 }, /* 6 */
      { .len=17, .from_start=0, .at_end=0, .last=1, .code=8, .pattern=7 }, /* 7 */
      { .len=15, .from_start=0, .at_end=0, .last=1, .code=10, .pattern=8 }, /* 8 */
      { .len=13, .from_start=0, .at_end=0, .last=1, .code=4, .pattern=9 }, /* 9 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=12, .pattern=10 }, /* 10 */
      { .len=5, .from_start=0, .at_end=0, .last=1, .code=15, .pattern=11 }, /* 11 */
      { .len=5, .from_start=0, .at_end=0, .last=1, .code=17, .pattern=12 }, /* 12 */
      { .len=8, .from_start=0, .at_end=0, .last=1, .code=19, .pattern=13 }, /* 13 */
      { .len=5, .from_start=0, .at_end=0, .last=1, .code=2, .pattern=14 }, /* 14 */
      { .len=11, .from_start=0, .at_end=0, .last=1, .code=21, .pattern=15 }, /* 15 */
      { .len=14, .from_start=0, .at_end=0, .last=1, .code=23, .pattern=16 }, /* 16 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=14, .pattern=17 }, /* 17 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=18, .pattern=18 }, /* 18 */
      { .len=8, .from_start=0, .at_end=0, .last=1, .code=6, .pattern=19 }, /* 19 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=1, .pattern=20 }, /* 20 */
      { .len=11, .from_start=0, .at_end=0, .last=0, .code=20, .pattern=21 }, /* 21 */
      { .len=7, .from_start=0, .at_end=0, .last=1, .code=12, .pattern=10 }, /* 22 */
      { .len=18, .from_start=0, .at_end=0, .last=1, .code=9, .pattern=22 }, /* 23 */
      { .len=26, .from_start=0, .at_end=0, .last=1, .code=27, .pattern=23 }, /* 24 */
      { .len=11, .from_start=0, .at_end=0, .last=1, .code=7, .pattern=24 }, /* 25 */
      { .len=5, .from_start=0, .at_end=0, .last=1, .code=16, .pattern=25 }, /* 26 */
      { .len=16, .from_start=0, .at_end=0, .last=1, .code=3, .pattern=26 }, /* 27 */
      { .len=15, .from_start=0, .at_end=0, .last=1, .code=13, .pattern=27 }, /* 28 */
      {}};
    char outgoings_w1[] =
		"#ABCDEFGHIJKLMNOPQRSTUVWX-./0123456789:EFGHIJKLMNOPQRnonopqrstDEFGHIJKLMNOPQRSTTxrstpqrsFGHIJKLMNOPQRS";
    ...
    struct aho_compiled w1 = {
        ...
        .patterns     = NULL    };
    /*
       Total length of all patterns 342 bytes
       sizeof a_node_w1		261*8 -> 2088 bytes
       sizeof pattern_list_w1	30*6 -> 180 bytes
       sizeof next_w1		102*2 -> 206 bytes
       sizeof outgoings_w1	103 bytes
     */
